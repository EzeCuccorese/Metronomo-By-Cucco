...
export const PRESET_PATTERNS: RhythmPattern[] = [
    {
        ...
        coverImage: '/genres/genre_rock.jpg',
        timeSignature: [4, 4],
        subdivision: 8,
    ...
    },
    {
        ...
        coverImage: '/genres/genre_blues.jpg',
        timeSignature: [4, 4],
    ...
    },
    {
        ...
        coverImage: '/genres/genre_samba.jpg',
        timeSignature: [2, 4],
    ...
    },
    {
        ...
        coverImage: '/genres/genre_chacarera.jpg',
        timeSignature: [6, 8],
    ...
    },
    {
        ...
        coverImage: '/genres/genre_milonga.jpg',
        timeSignature: [3, 4],
        subdivision: 12,
        instruments: ['bombo_leguero', 'rim', 'palmas'],
    ...
    },
    {
        ...
        coverImage: '/genres/genre_chamame.jpg',
        timeSignature: [6, 8],
        subdivision: 12,
    ...
    },
    {
        ...
        coverImage: '/genres/genre_salsa.jpg',
        timeSignature: [4, 4],
        subdivision: 16,
    ...
    },
    {
        ...
        coverImage: '/genres/genre_cumbia.jpg',
        timeSignature: [4, 4],
        subdivision: 16,
    ...
    },
    {
        ...
        coverImage: '/genres/genre_bossa.jpg',
        timeSignature: [4, 4],
        subdivision: 16,
    ...
    },
    {
        ...
        coverImage: '/genres/genre_malambo.jpg',
        timeSignature: [6, 8],
        subdivision: 12,
        instruments: ['bombo_leguero', 'rim'],
        grooveType: 'chacarera_poliritmica',
    ...
    },
    {
        ...
        coverImage: '/instruments/click.jpg',
        timeSignature: [4, 4],
        subdivision: 4,
        instruments: ['click'],
        grooveType: 'straight',
